...
const QuizDetail = () => {
    ...
    return (
        <div className="quiz-detail-container">
            <div 
                className="quiz-hero"
                style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), url(${quizHeroImage})` }}
            >
                <h1>{quiz.title}</h1>
            ...
            {!result ? (
                <div className="quiz-content">
                    <div className="question-container">
                        ...
                        <div className="options-grid">
                            {currentQuestion.options.map((option, index) => (
                                <div 
                                    key={index}
                                    className={`option-card ${selectedOptions[currentQuestion._id] === option.score ? "selected" : ""}`}
                    ...
                    <div className="navigation-buttons">
                        {currentQuestionIndex > 0 && (
                            <button onClick={goToPreviousQuestion} className="nav-button prev-button">Anterior</button>
                        )}
                ...
                <div className="result-container">
                    ...
                    <div className="result-actions">
                        ...
                        <button onClick={() => navigate('/')} className="action-button browse-button">
                            Volver al inicio
                        </button>
                    </div>
                </div>
